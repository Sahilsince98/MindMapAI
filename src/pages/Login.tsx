    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-100 via-purple-100 to-blue-100 flex items-center justify-center p-4 overflow-hidden">
      ...
      >
        ...
        <motion.button
          whileHover={{ scale: 1.05 }}
          whileTap={{ scale: 0.95 }}
          className="w-full bg-white border border-gray-300 text-gray-700 py-4 rounded-full font-bold text-lg shadow-lg mt-4 flex items-center justify-center gap-3"
