...
export const Report = ({data = [] }) => {
    ...
    if (data && data.report) {
        const testSummary = data.report["Test Summary"] ?? {};
        console.log("Test Summary:", testSummary);
    
        const totalScore = testSummary["Total Score"] ?? "N/A";
        const percentageScore = testSummary["Percentage Score"] ?? "N/A";
        const performanceLevel = testSummary["User ’s Performance Level"] ?? "N/A";
        const comparison = testSummary["Comparison with General Public"] ?? "N/A";
    
        console.log("Total Score:", totalScore);
        console.log("Percentage Score:", percentageScore);
        console.log("Performance Level:", performanceLevel);
        console.log("Comparison with General Public:", comparison);
    } else {
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                                <div className="flex flex-col items-center justify-center">
                                    ...
                                    <Badge
                                        ...
                                        style={{ backgroundColor: getPerformanceLevel(score).color }}
                                    >
                                        {getPerformanceLevel(score).label}
                                    </Badge>
                                </div>
